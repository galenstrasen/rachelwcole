		...
		<div id="header">
			<div class="header1">
				<div class="holder clearfix">
					...
					<div class="socials">
						<a class="facebook" href="<?php the_field('facebook_link', 'option'); ?>" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icon_nav-facebook.png"/></a>
						<a class="twitter" href="<?php the_field('twitter_link', 'option'); ?>" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icon_nav-twitter.png"/></a></a>
						<a class="instagram" href="<?php the_field('instagram_link', 'option'); ?>" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icon_nav-instagram.png"/></a></a>
						<a class="pinterest" href="<?php the_field('pinterest_link', 'option'); ?>" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icon_nav-pinterest.png"/></a></a>
						<a class="rss" href="<?php bloginfo('url')?>/feed/" target="_blank"><img src="<?php bloginfo('template_url')?>/img/icon_nav-rss.png"/></a></a>
						<a href="#" class="mobile-nav-icon"><img src="<?php bloginfo('template_url')?>/img/mobile-nav-icon.png"/></a>
					</div>
				</div>
			</div>
			<div class="header2">
