    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6 col-sm-offset-0 col-xs-7 col-xs-offset-2">
          <img src="<?php bloginfo('template_url')?>/template-replenish/assets/img/image-collage_1.jpg" class="img-responsive" alt="How Replinish Came to Be" />
        </div>
      </div>
    </div><!-- /container -->
  </div><!-- /collage-section -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6 col-sm-offset-0 col-xs-7 col-xs-offset-3">
          <img src="<?php bloginfo('template_url')?>/template-replenish/assets/img/image-collage_2.jpg" class="img-responsive collage-img-2" alt="Wedding Day" />
        </div>
        <div class="col-sm-6 col-sm-offset-0 col-xs-10 col-xs-offset-1">
