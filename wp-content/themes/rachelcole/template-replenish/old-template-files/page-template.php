...
<?php get_template_part('template-replinish/head'); ?>
  <?php
...
<body <?php body_class(); ?>>
  ...
  <![endif]-->
        ...
        <![endif]-->
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url')?>/template-replinish/assets/css/main.css" media="all">
...
<link rel="stylesheet" type="text/css" href="<?php bloginfo('template_url')?>/template-replinish/assets/css/new_feast.css" media="all">
		...
		<script src="<?php bloginfo('template_url')?>/template-replinish/assets/js/feast-copy.js"></script>
